...
std::vector<Timbre> SoundBank = {
  ...
  // Test:
  Timbre("Indian/SITAR", {60}), // Sa (C4)
  // // Timbre("Indian/SITAR", {60, 67}), // Sa (C4), Pa (G4)
  // // Timbre("Indian/SITAR", {60, 67, 72}), // Sa (C4), Pa (G4), High Sa (C5)
  // Timbre("Indian/SITAR", {60, 62, 64, 65, 67, 69, 71, 72}), // Sa, Re, Ga, Ma, Pa, Dha, Ni, Sa = C4, D4, E4, F4, G4, A4, B4, C5
};
